...
var dashboard_default = {
    init: function() {
        $("#custom-line-chart").sparkline([24, 27, 8, 18, 12, 8, 40, 33, 37, 25, 22, 18, 25, 2, 4, 15, 10, 11, 15, 14, 6, 8, 6, 8, 30, 25], {
            ...
            chartRangeMax: '50',
            lineColor: 'rgba(56,  211, 231, 1)',
            fillColor: 'rgba(56,  211, 231, 0.8)',
            ...
            tooltipClassname: 'chart-sparkline',
            chartRangeMax: '40',
            lineColor: 'rgba(188,  160, 238, 1)',
            fillColor: 'rgba(188,  160, 238, 0.8)',
            ...
            tooltipClassname: 'chart-sparkline',
            lineColor: '#59a6fe',
            fillColor: 'rgba(89,  166, 254, 0.80)',
            ...
            labelColor: "#777777",
            colors: ["rgba(171, 140, 228, 0.9)", "rgba(38, 198, 218, 0.9)" ,"rgba(0, 194, 146, 0.9)" ,"rgb(64, 153, 255, 0.9)" ],
...
var myLineChart = {
    ...
    datasets: [{
        ...
        strokeColor: "#26c6da",
        pointColor: "#26c6da",
        data: [20, 40, 10, 20, 40, 25, 40, 10, 20]
    }, {
        fillColor: "rgb(64, 153, 255 , 0.8)",
        strokeColor: "#4099ff",
        pointColor: "#4099ff",
        data: [60, 10, 20, 40, 20, 30, 20, 50, 0]
    }]
}
